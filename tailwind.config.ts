...
const twConfig: Config = {
  ...
  theme: {
    extend: {
      fontFamily: {
        sans: 'var(--font-sans),system-ui,Poppins,-apple-system,PingFang SC,"Microsoft YaHei",Segoe UI,Roboto,Helvetica,noto sans sc,hiragino sans gb,"sans-serif",Apple Color Emoji,Segoe UI Emoji,Not Color Emoji',
        serif:
